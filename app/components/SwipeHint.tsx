              ...
              <div className="flex-grow">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Glissez jusqu'au bout vers la gauche pour terminer</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Glissez jusqu'au bout vers la droite pour supprimer</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-2 mt-3 p-2 bg-blue-50 rounded-lg">
                    ...
                    <span className="text-xs text-blue-700">La tâche revient au centre si vous ne glissez pas assez loin</span>
                  </div>
                </div>
              </div>
